...
function VisitorSignup() {
    ...
    const validate = () => {
        ...
        if (!formData.password.trim()) {
            ...
            errors.password = 'Password must be at least 6 characters long, contain a special symbol, and include an uppercase character.';
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/mettings');
            setFormData({ name: '', phone: '', email: '', password: '', image: null, CompanyName: '' });
        } catch (error) {
            console.error('Error adding visitor:', error);
            Swal.fire({
                icon: 'warning',
            ...
            <div className="mx-4 mb-4 -mt-16">
                ...
                >
                    ...
                    <div className="mt-8 flex justify-between items-center">
                        ...
                        <Link to="/Visitorlogin" className="text-blue-500 hover:underline text-lg">
                            LogIn
                        </Link>
                    </div>
                </form>
