...
//             try {
//                 const res = await axios.get(`http://localhost:5000/todayMeetings/${visitor.email}`);
...
//                             You Dont Have Any Meeting Today
//                         </div>
//                     )
//             } */}
//             {
            ...
            try {
                ...
                if (res.status === 404) {
                    Swal.fire({
                        ...
                        text: `You Have to Make Appointment First`,
                    });
                    navigate('/meeting-request');
                }
            } catch (error) {
