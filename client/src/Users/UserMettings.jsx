...
// //                 `http://localhost:5000/my-metting/${user.username}`
// //             );
...
//                                                         </button>
//                                                         <input
//                                                             className="border rounded border-slate-600 ml-2 mr-3 mx-auto h-auto"
//                                                             placeholder="Enter reason for rejectiona"
//                                                             onChange={(e) => setDescription(e.target.value)}
//                                                             value={description}
//                                                             required
//                                                         />
...
function UserMeetings() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (user.role === "Admin") {
                const res = await axios.get("http://localhost:5000/AllMeetings"); // Admin API call
                setMeetings(res.data); // Update state with all meetings
            } else {
                const res = await axios.get(
                    `http://localhost:5000/my-metting/${user.username}`
                );
