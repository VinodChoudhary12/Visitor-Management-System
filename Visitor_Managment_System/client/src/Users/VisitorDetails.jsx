...
const VisitorDetails = () => {
    ...
    async function getData() {
        try {
            const response = await axios.get(`http://localhost:5000/visitor/${1}`);
            //const response = await axios.get(`http://localhost:5000/visitor/${visitorDetails.id}`);
                ...
                {visitorDetails ? (
                    <>
                        <section className="py-10 my-auto ">
                                         ...
                                         <input type="file" name="profile" id="upload_cover" hidden required />
                                            ...
                                            <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                                                <div className="w-full">
                                                    ...
                                                    {/* <select
                                             className="w-full text-grey border-2 rounded-lg p-4 pl-2 pr-2 :text-gray-200 :border-gray-600 :bg-gray-800">
                                            ...
                                            {/* <div className="flex justify-between  w-full items-center gap-3 rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                                                 ...
                                                 <button className='w-1/3 p-4' onClick={() => changeStatus('CHECKED_IN') }>Check In</button>
                                                 <button className='w-1/3 p-4' onClick={() => changeStatus('CHECKED_OUT')}>Check_Out</button>
                                             </div> */}
                                            <div className="flex justify-between w-full items-center gap-3 rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                                                <button
                                                    className="w-1/3 p-4"
                            ...
                            <div onClick={() => navigate('/today-all-meetings')} className="w-full p-4 rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold text-center ">Back</div>
                        </section>
