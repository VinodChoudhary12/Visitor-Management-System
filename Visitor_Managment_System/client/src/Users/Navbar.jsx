            ...
            <nav className="bg-white border-b border-gray-200">
                ...
                <div className={`${isMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <Link href="#" className="text-gray-600 hover:text-gray-800 block px-3 py-2 rounded-md text-base font-medium">My Meetings</Link>
                    </div>
                </div>
                {isSliderOpen && (
                    <div className="fixed inset-0 sm:inset-y-0 sm:right-0 sm:w-1/3 w-full h-full bg-white shadow-lg p-4 overflow-y-auto z-20 mx-auto sm:mx-0">
                        <div className="flex justify-between items-center">
                            ...
                            <button onClick={() => { setIsSliderOpen(false); setNotifications([]); }} className="text-2xl font-semibold mb-4">X</button>
                        </div>
