                            ...
                            {notifications.length > 0 ? (
                                notifications.map((not) => (
                                    <div key={not.id} className="flex justify-between hover:underline cursor-pointer" onClick={() => navigate(`/QR/${not.id}`)}>
                                        ...
                                        {
                                            not.status === "APPROVED"
                                                ? `Your Meeting of ${formatMeetingTime(not.meeting_time)} has been Approved by the  ${not.meetingTo}`
                                                : `Your Meeting of ${formatMeetingTime(not.meeting_time)} has been Rejected by the  ${not.meetingTo}`
                                        }
